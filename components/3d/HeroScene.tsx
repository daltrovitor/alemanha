...
export default function GlobalScene({ isReplaying, onReplayFinished, onLoadComplete }: GlobalSceneProps) {
    ...
    return (
        <div ref={containerRef} className="fixed inset-0 w-full h-screen bg-de-dark opacity-0 z-0 pointer-events-none overflow-hidden">
            <Loader isReplaying={isReplaying} onReplayFinished={onReplayFinished} onLoadComplete={onLoadComplete} />
            ...
            <div className="bg-image-layer absolute inset-0 z-0 pointer-events-none transition-opacity duration-1000">
                <div className="absolute inset-0 bg-de-steel opacity-15 mix-blend-color" />
                <div className="absolute inset-0 bg-gradient-to-b from-de-dark/50 via-transparent to-de-dark" />
            </div>
